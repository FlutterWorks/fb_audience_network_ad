...
class SwiftFacebookAudienceNetworkNativeAdFactory: NSObject, FlutterPlatformViewFactory {
    ...
    func create(withFrame frame: CGRect, viewIdentifier viewId: Int64, arguments args: Any?) -> FlutterPlatformView {
        ...
        return SwiftFacebookAudienceNetworkNativeAdView(_frame: frame,
                                                _viewId: viewId,
...
class SwiftFacebookAudienceNetworkNativeAdLayout {
    var adView: CGRect!
...
class SwiftFacebookAudienceNetworkNativeAdView: NSObject, FlutterPlatformView, FBNativeAdDelegate {
    ...
    var nativeAdLayout: SwiftFacebookAudienceNetworkNativeAdLayout!
    // custom
    var adView: UIView!
...
//        }
    ...
    func initNativeAdViewAttributesCustomHorizontal() {
        ...
        self.nativeAdLayout = SwiftFacebookAudienceNetworkNativeAdLayout()
