...
class SwiftFacebookAudienceNetworkBannerAdFactory: NSObject, FlutterPlatformViewFactory {
    let registrar: FlutterPluginRegistrar
    init(_registrar: FlutterPluginRegistrar) {
        print("BannerAdFactory > Factory register")
    ...
    func createArgsCodec() -> FlutterMessageCodec & NSObjectProtocol {
        print("BannerAdFactory > Factory createArgsCodec")
        
        return FlutterStandardMessageCodec.sharedInstance()
    }
    
    func create(withFrame frame: CGRect, viewIdentifier viewId: Int64, arguments args: Any?) -> FlutterPlatformView {
        print("BannerAdFactory > Factory create")
        
        return SwiftFacebookAudienceNetworkBannerAdView(_frame: frame,
                                                        _viewId: viewId,
...
class SwiftFacebookAudienceNetworkBannerAdView: NSObject, FlutterPlatformView, FBAdViewDelegate {
     ...
     **/
    func initFB() {
        print("BannerAdView > init initFB")
...
//            initBannerAdViewAttributes()
     ...
     **/
    func initBannerAd() {
        print("BannerAdView > init initBannerAd")
    ...
    func regBannerAdViewTemplate() {
        print("BannerAdView > regNativeAdViewTemplate")
    ...
    func adViewDidClick(_ adView :FBAdView) {
        print("BannerAdView > adViewDidClick")
    ...
    func adViewDidFinishHandlingClick(_ adView :FBAdView) {
        print("BannerAdView > adViewDidFinishHandlingClick")
    }
    /**
    ...
    func adViewDidLoad(_ adView :FBAdView) {
        print("BannerAdView > adViewDidLoad")
