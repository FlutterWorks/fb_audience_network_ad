...
class SwiftFacebookAudienceNetworkNativeBannerAdFactory: NSObject, FlutterPlatformViewFactory {
    ...
    func create(withFrame frame: CGRect, viewIdentifier viewId: Int64, arguments args: Any?) -> FlutterPlatformView {
        ...
        return SwiftFacebookAudienceNetworkNativeBannerAdView(_frame: frame,
                                                        _viewId: viewId,
...
class SwiftFacebookAudienceNetworkNativeBannerAdView: NSObject, FlutterPlatformView, FBNativeBannerAdDelegate {
